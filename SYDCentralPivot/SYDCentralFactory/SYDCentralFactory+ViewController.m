...
- (UIViewController *) getOneUIViewController:(const NSString *) viewControllerKey
{
    ...
    {
       LOG_DEBUGGING_NS(@"SYDCentralFactory_getOneUIViewController: class for [%@] is not exist",viewControllerKey);
        return nil;
    }
    ...
    {
        LOG_DEBUGGING_NS(@"SYDCentralFactory_getOneViewController: method for [%@] not exist ",viewControllerKey);
        ...
        [param enumerateKeysAndObjectsUsingBlock:^(id key,id value,BOOL * stop)
         {
             ...
             {
                 LOG_DEBUGGING_NS(@"SYDCentralFactory_getOneUIViewControllerWithInjectParam: value for key[%@] not exist,exception[%@]",viewControllerKey,exception);
             }
...
- (Class) getViewControllerClass:(const NSString *) viewControllerKey
{
    ...
    if(!viewControllerClass)
    {
        ...
        {
            LOG_DEBUGGING_NS(@"SYDCentralFactory_getViewControllerClass: model for [%@] is not exist",viewControllerKey);
            return nil;
        }
